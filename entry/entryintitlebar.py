from custom import CTT, Y, isDark # Load "CTT" class (You also can load X, TOP... from custom.py)
from tkinter.ttk import Entry # From tkinter.ttk import Entry
from sv_ttk import set_theme # Optional, You can use sun-valley-ttk theme

example = CTT()
example.title("CTT example") # Optional
example.geometry(980, 560) # Optional
